...
public class NewMessageDialog extends TitleAreaDialog implements PropertyChangeListener {
	...
	private void createInfoDecorations() {
		createInfoDecoration(m_recipientsText, 
				"This is the recipients field. Use context help to find out more.", 
				FieldDecorationRegistry.DEC_INFORMATION);
		createInfoDecoration(m_subjectText, 
				"This is the subject field. Use context help to find out more.", 
				FieldDecorationRegistry.DEC_INFORMATION);
	}
	
	private static void createInfoDecoration(Control ctrl, String infoTxt, String imageId) {
		ControlDecoration deco = new ControlDecoration(ctrl, SWT.LEFT);
		deco.setDescriptionText(infoTxt);
		deco.setImage(FieldDecorationRegistry.getDefault().getFieldDecoration(imageId).getImage());
		deco.setMarginWidth(5);
		deco.setShowOnlyOnFocus(false);
	}

	private void createTooltips() {
		createTooltip(m_recipientsText, 
				"This is the recipients field. Use context help to find out more.");
		createTooltip(m_subjectText, 
		"This is the subject field. Use context help to find out more.");
		createTooltip(m_messageText, 
		"This is the text area. Use context help to find out more.");
	}
	private static void createTooltip(Control ctrl, String infoTxt) {
		ctrl.setToolTipText(infoTxt);
	}
